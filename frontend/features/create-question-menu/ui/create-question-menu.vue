...
<template>
    ...
    >
        <DropdownOption @click="createQuestion('SHORT_TEXT')">
            ...
            >
                <g clip-path="url(#clip0_103_66)">
                    <path
                        d="M1.64258 16.8636H13.964M1.64258 11.9545H21.3569M1.64258 7.04544H13.964M1.64258 2.13635H21.3569"
                        stroke="white"
                        stroke-width="2"
        ...
        <DropdownOption @click="createQuestion('MULTILINE_TEXT')">
            ...
            >
                <path
                    d="M1.64258 16.8636H13.964M1.64258 11.9545H21.3569M1.64258 7.04546H13.964M1.64258 2.13637H21.3569"
                    stroke="white"
                    stroke-width="2"
                    stroke-linecap="round"
                    stroke-linejoin="round"
        ...
        <DropdownOption @click="createQuestion('SINGLE_CHOICE')">
            <svg
                class="w-6"
                viewBox="0 0 23 24"
                fill="none"
