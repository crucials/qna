...
<template>
    ...
    >
        <div v-if="survey">
            ...
            <p class="mb-5 text-center">Click on the link to copy</p>

            <button
                class="p-4 bg-neutral-800 rounded-lg flex items-center gap-x-4 text-neutral-500 w-full group overflow-hidden"
                title="Copy"
                @click="copy"
            >
                <svg
