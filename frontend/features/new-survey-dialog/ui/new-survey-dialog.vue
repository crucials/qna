...
<template>
    ...
    >
        <div v-if="survey">
            ...
            <button
                class="p-4 bg-neutral-800 rounded-lg flex items-center gap-x-4
                    text-neutral-500 w-full group overflow-hidden"
                title="Copy"
                @click="copy"
            >
                <svg class="w-5 flex-shrink-0" viewBox="0 0 315 315" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
                        fill-rule="evenodd"
                        clip-rule="evenodd"
                        ...
                        class="transition-colors duration-300 fill-neutral-600
