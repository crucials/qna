...
const UNDERLINED_FIELD_STYLES =
    'border-t-transparent border-r-transparent border-l-transparent border-b-1 ' +
...
<template>
    <div class="relative" :class="wrapperClass">
        <component
            ...
            "
            class="block py-3 px-5 border-neutral-700 border bg-neutral-900 rounded-lg focus-visible:ring-2 focus-visible:ring-amethyst-light/60 placeholder:text-neutral-500 transition-colors w-full disabled:opacity-65"
            :class="{
