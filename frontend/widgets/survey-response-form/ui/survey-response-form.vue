...
<template>
    <form>
        ...
        <div class="relative bg-neutral-950 rounded-lg p-7 max-w-6xl min-h-4">
            ...
            <svg
                class="absolute right-[3%] top-1/4 scale-0 transition-transform duration-500"
            ...
            <div class="relative">
                ...
                >
                    <div
                        class="bg-enchanted-amethyst absolute top-0 left-0 h-full w-full transition-opacity duration-300 group-hover:opacity-0"
                    ></div>
